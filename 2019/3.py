...
for wire in wires:
    ...
    for path in paths:
        ...
        for i in range(int(steps)):
            ...
            if direction == 'D':
                current_position = (current_position[0]-1, current_position[1])
            if current_position not in seen and current_position != (0, 0):
    ...
    for path in paths:
        ...
        for i in range(int(steps)):
            ...
            if direction == 'D':
                current_position = (current_position[0]-1, current_position[1])
            step_distance += 1
            if not current_position in distances[w]:
                distances[w][current_position] =  step_distance
                seen[w].add(current_position)
intersections = seen[0].intersection(seen[1])
print(min([distances[0][i] + distances[1][i] for i in intersections]))